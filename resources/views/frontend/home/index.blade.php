                            ...
                            <li class="pr-0">
                                <div class="dropdown">
                                    <button type="button" id="dropdownMenuButton-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="{{ url('assets/frontend/images/flag/1.jpg') }}" alt="" /> English <i class="ion-ios-arrow-down"></i>
                                    </button>

                                    <ul class="dropdown-menu animation slideDownIn" aria-labelledby="dropdownMenuButton-3">
                                        <li>
                                            <a href="#"><img src="{{ url('assets/frontend/images/flag/1.jpg') }}" alt="" /> English</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ url('assets/frontend/images/flag/2.jpg') }}" alt="" /> Français</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <ul class="menu-content display-none">
                                <li class="menu-item">
                                    ...
                                    <ul class="sub-menu flex-wrap">
                                        ...
                                        <li>
                                            <img src="{{ url('assets/frontend/images/menu-image/banner-mega1.jpg') }}" alt="" />
                                        </li>
                                    </ul>
                                    <!-- sub menu -->
                                </li>
                                        ...
                                        <li class="w-100">
                                            <ul class="banner-megamenu-wrapper d-flex">
                                                <li class="banner-wrapper mr-30px">
                                                    <a href="single-product.html"><img src="{{ url('assets/frontend/images/menu-image/banner-menu2.jpg') }}" alt="" /></a>
                                                </li>
                                                <li class="banner-wrapper">
                                                    <a href="single-product.html"><img src="{{ url('assets/frontend/images/menu-image/banner-menu3.jpg') }}" alt="" /></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ url('assets/frontend/images/product-image/1.jpg') }}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ url('assets/frontend/images/product-image/2.jpg') }}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ url('assets/frontend/images/product-image/3.jpg') }}" alt="Cart product Image"></a>
                        <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6 mb-md-30px mb-lm-30px">
                        <div class="single-static">
                            <img src="{{ url('assets/frontend/images/icons/static-icons-1.png') }}" alt="" class="img-responsive" />
                    ...
                    <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6 mb-md-30px mb-lm-30px">
                        <div class="single-static">
                            <img src="{{ url('assets/frontend/images/icons/static-icons-2.png') }}" alt="" class="img-responsive" />
                            <div class="single-static-meta">
                                <h4>Free Returns</h4>
                    ...
                    <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6 mb-sm-30px">
                        <div class="single-static">
                            <img src="{{ url('assets/frontend/images/icons/static-icons-4.png') }}" alt="" class="img-responsive" />
                            <div class="single-static-meta">
                                <h4>Support 24/7</h4>
                    ...
                    <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                        <div class="single-static">
                            <img src="{{ url('assets/frontend/images/icons/static-icons-3.png') }}" alt="" class="img-responsive" />
                            <div class="single-static-meta">
            ...
            <div class="category-slider slider-nav-style-1">
                <div class="category-slider-wrapper swiper-wrapper">
                    <div class="category-slider-item swiper-slide">
                        <div class="thumb-category">
                            <a href="single-product.html">
                                <img src="{{ url('assets/frontend/images/product-image/1.jpg') }}" alt="product-image.jpg" />
                            </a>
                        </div>
                    ...
                    <div class="category-slider-item swiper-slide">
                        <div class="thumb-category">
                            <a href="single-product.html">
                                <img src="{{ url('assets/frontend/images/product-image/2.jpg') }}" alt="product-image.jpg" />
                            </a>
                        </div>
                        <div class="category-discript">
                            <h4>Audio & Video</h4>
                    ...
                    <div class="category-slider-item swiper-slide">
                        <div class="thumb-category">
                            <a href="single-product.html">
                                <img src="{{ url('assets/frontend/images/product-image/3.jpg') }}" alt="product-image.jpg" />
                            </a>
                        </div>
                        <div class="category-discript">
                            <h4>Video Games</h4>
                    ...
                    <div class="category-slider-item swiper-slide">
                        <div class="thumb-category">
                            <a href="single-product.html">
                                <img src="{{ url('assets/frontend/images/product-image/4.jpg') }}" alt="product-image.jpg" />
                            </a>
                        </div>
                        <div class="category-discript">
                    ...
                    <div class="category-slider-item swiper-slide">
                        <div class="thumb-category">
                            <a href="single-product.html">
                                <img src="{{ url('assets/frontend/images/product-image/5.jpg') }}" alt="product-image.jpg" />
                            </a>
                        </div>
                        <div class="category-discript">
                            <h4>Camera & Photo</h4>
                ...
                <div class="feature-slider-wrapper swiper-wrapper">
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/12.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/13.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/14.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/15.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/16.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/17.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/20.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/21.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/22.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/23.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/24.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/25.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/26.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/27.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="feature-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/28.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/29.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    ...
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/11.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                ...
                <div class="deal-slider-wrapper swiper-wrapper">
                    ...
                    <div class="deal-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/29.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/17.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <div class="deal-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/21.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/23.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <div class="deal-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/9.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/28.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                ...
                <div id="tab-1" class="tab-pane active">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 mt-lm-55px">
                            <div class="banner-wrapper">
                                <a href="shop-4-column.html"><img src="{{ url('assets/frontend/images/banner-image/5.jpg') }}" alt="" /></a>
                            </div>
                        </div>
            ...
            <div class="tab-content banner-area">
                ...
                <div id="tab-4" class="tab-pane active">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 mt-lm-55px">
                            <div class="banner-wrapper">
                                <a href="shop-4-column.html"><img src="{{ url('assets/frontend/images/banner-image/6.jpg') }}" alt="" /></a>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8">
                            <div class="feature-slider-2 slider-nav-style-1">
            ...
            <div class="brand-slider slider-nav-style-1 slider-nav-style-2 ">
                <div class="brand-slider-wrapper swiper-wrapper">
                    <div class="brand-slider-item swiper-slide">
                        <a href="#"><img src="{{ url('assets/frontend/images/brand-logo/1.jpg') }}" alt="" /></a>
                    </div>
                    <div class="brand-slider-item swiper-slide">
                        <a href="#"><img src="{{ url('assets/frontend/images/brand-logo/2.jpg') }}" alt="" /></a>
                    </div>
                    <div class="brand-slider-item swiper-slide">
                        <a href="#"><img src="{{ url('assets/frontend/images/brand-logo/3.jpg') }}" alt="" /></a>
                    </div>
                    <div class="brand-slider-item swiper-slide">
                        <a href="#"><img src="{{ url('assets/frontend/images/brand-logo/4.jpg') }}" alt="" /></a>
                    </div>
                    <div class="brand-slider-item swiper-slide">
                        <a href="#"><img src="{{ url('assets/frontend/images/brand-logo/5.jpg') }}" alt="" /></a>
                    </div>
                    <div class="brand-slider-item swiper-slide">
                        <a href="#"><img src="{{ url('assets/frontend/images/brand-logo/1.jpg') }}" alt="" /></a>
                    </div>
                ...
                <div class="recent-slider-wrapper swiper-wrapper">
                    ...
                    <div class="recent-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/15.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/16.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    ...
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/18.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    ...
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/20.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="recent-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/21.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/22.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="recent-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/23.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/24.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="recent-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/25.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/26.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="icon-magnifier icons"></i>
                    ...
                    <div class="recent-slider-item swiper-slide">
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="{{ url('assets/frontend/images/product-image/27.jpg') }}" alt="" />
                                    <img class="second-img" src="{{ url('assets/frontend/images/product-image/28.jpg') }}" alt="" />
                                </a>
                                <div class="quick-view">
                                    <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <img class="payment-img" src="{{ url('assets/frontend/images/icons/payment.png') }}" alt="" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-container gallery-top">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ url('assets/frontend/images/product-image/11.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ url('assets/frontend/images/product-image/12.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ url('assets/frontend/images/product-image/13.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ url('assets/frontend/images/product-image/14.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
